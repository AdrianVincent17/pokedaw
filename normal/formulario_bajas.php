                ...
                <div class="col-9 col-sm-8 col-md-6 col-xl-4 mx-auto d-block">
                    <div class="row justify justify-content-center titulos mt-5 mb-4">
                        <div class="col-12 mt-4">
                            ...
                            $consulta = "SELECT email FROM usuarios WHERE nif = '$nif_usuario_actual'";
                            ...
                            ?>
                                <h4 class="text-center text-light mb-4">Confirmar Eliminación de Cuenta</h4>
                                
                                <form action="bajas.php" method="POST">
                                    <p class="text-center text-light">Estás a punto de eliminar la cuenta asociada al E-mail:</p>
                                    <p class="text-center text-light"><strong><?php echo $email_usuario_actual; ?></strong></p>
                                    
                                    <input type="hidden" name="deleteuser" value="<?php echo $nif_usuario_actual; ?>">
                                    
                                    <div class="d-grid gap-2">
                                        <input type="submit" class="col-11 ms-4 mb-2 btn btn-danger mt-3" value="Eliminar Mi Cuenta Permanentemente">
                                    </div>
                                </form>
                            <?php
                            } else {
